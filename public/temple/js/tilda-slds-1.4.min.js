function t_sldsInit(t, e) { window.t_userAgentParser = { userAgent: window.navigator.userAgent, getIOSMajorVersion: function() { var t = "iPhone OS"; try { var e = this.userAgent.search(t); if (-1 !== e) { var s = e + t.length + 1,
                        a = this.userAgent.slice(s),
                        i = a.match(/(\d{1,3}_\d{1,3}(_\d{1,3})?)/),
                        d = parseInt(i[0]); return d } return null } catch (t) { console.log("error in userAgentParser > getIOSMajorVersion" + t.message) } }, isIOSMobileChrome: function() { return !!navigator.userAgent.match("CriOS") } }; var s = "object" == typeof t ? t : $("#rec" + t); if (0 === s.length) return !1; var a = s.find(".t-slds__item"),
        i = a.length,
        d = a.filter(":first"),
        r = a.filter(":last"),
        l = $(window).width(),
...
function t_slds_initSliderControls(t, e) { var s = "object" == typeof t ? t : $("#rec" + t),
        ...
        r = a.attr("data-slider-stop"); if ("true" == r) return !1;
    a.css({ transform: "translateX(-" + d + "px)" }), s.find(".t-slds__arrow_wrapper").click(function() { var i = t_slds_getCurrentTranslate(s),
            d = a.attr("data-slider-animated"),
            r = parseFloat(a.attr("data-slider-pos")),
            l = parseFloat(a.attr("data-slider-totalslides")),
            n = ""; if ("" == d) { a.attr("data-slider-animated", "yes"); var o = $(this).attr("data-slide-direction"); "left" === o ? "false" == a.attr("data-slider-with-cycle") && 1 == r ? r = 1 : r-- : "false" == a.attr("data-slider-with-cycle") && r == l ? r = l : r++, a.attr("data-slider-pos", r), r != l + 1 && 0 != r || (n = "yes"), a.attr("data-slider-cycle", n), t_slideMove(t, !1, e, i) } s.trigger("updateSlider") }), s.find(".t-slds__bullet").click(function() { var i = t_slds_getCurrentTranslate(s),
            d = parseFloat($(this).attr("data-slide-bullet-for"));
        a.attr("data-slider-pos", d), t_slideMove(t, !1, e, i), s.trigger("updateSlider") }) }

function t_slds_animate(t, e, s) { var a = performance.now();
    requestAnimationFrame(function i(d) { var r = (d - a) / s;
        r > 1 && (r = 1); var l = t(r);
        e(l), r < 1 ? requestAnimationFrame(i) : "y" == window.lazy && t_lazyload_update() }) }

function t_slide_MoveAnimation(t, e, s, a) { if (t[0]) { t[0].style.transition = "height ease-in-out .5s, transform ease-in-out 0s"; var i = -Math.abs(e * s),
            d = -parseInt(t[0].style.transform.match(/\d+/)[0]),
            r = d - i;
        0 !== r && t_slds_animate(function(t) { return t }, function(e) { t[0].style.transform = "translateX(" + (d - r * e) + "px)" }, a) } }
...
function t_slds_UpdateImages(t, e) { var s = "object" == typeof t ? t : $("#rec" + t),
...
function t_slds_scrollImages(t, e) { var s = "object" == typeof t ? t : $("#rec" + t),
        a = (e < 0 ? "" : "-") + Math.abs(e).toString();
    s.find(".t-slds__items-wrapper").css("transform", "translateX(" + a + "px)") }

function t_slds_ActiveBullet(t, e, s, a) { var i; if (a && a.thumbsbulletGallery) { var d = parseInt(a.storeOptions.popup_opts.columns),
            r = +a.storeOptions.slider_slidesOpts.ratio;
        i = t_store_prodPopup_gallery_calcMaxThumbsCount(d, r, 60, 10) } var l = "object" == typeof t ? t : $("#rec" + t),
...
function t_slds_SliderWidth(t) { var e = "object" == typeof t ? t : $("#rec" + t),
        ...
        r = i.attr("data-slider-items-in-row"); if ("true" == d) return !1;
    e.find(".t-slds__items-wrapper").width(s * a), window.innerWidth <= 640 ? r = 1 : window.innerWidth <= 960 && r > 1 && (r = 2); var l = r && r > 1 ? s / r : s;
    e.find(".t-slds__item").width(l) }

function t_slds_SliderHeight(t) { var e = "object" == typeof t ? t : $("#rec" + t);
    e.find(".t-slds__items-wrapper").css("height", e.find(".t-slds__item_active").height()) }
...
function t_slds_initAutoPlay(t, e, s, a) { var i = "object" == typeof t ? t : $("#rec" + t),
        d = i.find(".t-slds"),
        r = i.find(".t-slds__items-wrapper"),
        l = parseFloat(r.attr("data-slider-timeout")),
        n = "",
        o = r.attr("data-slider-stop"),
        _ = r.attr("data-slider-interval-id"); if (_ && clearInterval(_), "true" == o) return !1;
    window.isMobile || d.hover(function() { r.attr("data-slider-stopped", "yes") }, function() { r.attr("data-slider-stopped", "") }), $(window).bind("scroll", t_throttle(function() { var t = i.offset().top,
            e = t + i.outerHeight(),
            s = $(window).scrollTop(),
            a = s + $(window).height();
        e > s && t < a ? r.attr("data-slider-stopped", "") : r.attr("data-slider-stopped", "yes") }, 200)); var c = setInterval(function() { var d = $(window).scrollTop(),
            l = $(window).height(),
            o = i.offset().top,
            _ = i.innerHeight(),
            ...
            m = t_slds_getCurrentTranslate(i);
        d + l / 2 > o && o + _ > d && "yes" != c && "yes" != f && "yes" != p && ("false" == r.attr("data-slider-with-cycle") && e == s ? e = s : e++, r.attr("data-slider-pos", e), e != s + 1 && 0 != e || (n = "yes"), t_slideMove(t, !0, a, m), "yes" == n && (e == s + 1 && (e = 1), 0 == e && (e = s), r.attr("data-slider-pos", e)), r.attr("data-slider-cycle", n)) }, l);
...
function t_slds_initSliderSwipe(t, e, s) { var a, i = "object" == typeof t ? t : $("#rec" + t),
        d = i.find(".t-slds__items-wrapper"),
        r = d.attr("data-slider-stop"),
        l = !1; if ("true" == r) return !1;}
        
function t_slds_getCurrentTranslate(t) { var e = t.find(".t-slds__items-wrapper"); if (e) { var s = e[0].style.transform.indexOf("(") + 1,
            a = e[0].style.transform.indexOf("px"),
            i = parseInt(e[0].style.transform.slice(s, a)); return i } }

function t_slds_changeImageUrl(t) { var e = "object" == typeof t ? t : $("#rec" + t);
    e.find(".t-slds__img").each(function() { var t = $(this);
        void 0 !== t.attr("data-src") && (t = $(this), t.attr("src", t.attr("data-src")), t.removeAttr("data-src")) }) }
    if($('#rec89090443 .t-slds__item').length > 1){
        setInterval(function() {
            var i = $('#rec89090443 .t-slds__bullet').length;
            console.log($('#rec89090443 .t-slds__bullet.t-slds__bullet_active').data("slide-bullet-for"));
            if($('#rec89090443 .t-slds__bullet.t-slds__bullet_active').data("slide-bullet-for") == i){
                $('#rec89090443 .t-slds__bullet[data-slide-bullet-for="1"]').click();
            } else {
                $('#rec89090443 .t-slds__bullet[data-slide-bullet-for="'+($('#rec89090443 .t-slds__bullet.t-slds__bullet_active').data("slide-bullet-for") + 1)+'"]').click();
            }
        }, 5000);
    }
