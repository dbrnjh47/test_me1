        ...
        if(r.type == 'newGame') {
			...
			if(room == r.room) {
                ...
                if(r.data.data.game.bonus > 0)
                    updateBonus(parseFloat(r.data.data.game.bonus));
			}
        ...
        let bet =  `
            ...
            display: flex;justify-content: space-between;">
                ...
                <div class="namentickets">
                    <h2 style="margin-top: 0px;line-height: normal;">БОНУСНЫЙ БОТ СТАВИТ ПРОЦЕНТ ОТ КОМИССИИ ПОСЛЕДНЕЙ ИГРЫ.</h2>
                    
                </div>
                <div style="    margin-top: 0px;" class="sumnchance">
                    <h2 style="color: #00e612;">
                    ${bonus.toFixed(2)}
    ...
    function JackpotParse(res) {
        ...
        res.bets.forEach(bet => {
            ...
            bets += `<li >
                ...
                <div class="namentickets" onclick="getNickname(${bet.bet.id}, ${bet.bet.from}, ${bet.bet.to})">
